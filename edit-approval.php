...
<html lang="en">
    <head>
        ...
        <title>SLS Admin | Subject For Approval </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Subject For Approval</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="manage-pending-approval.php">Pending Approval</a></li>
                                            ...
                                            <?php          
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-6" style="text-align: left;">
                                                            <button type="submit" name="approved" class="btn btn-primary" style="width: 30%;">Approve</button>
                                                        </div>
                                                        <div class=" col-lg-6"  style="text-align: right;">
                                                            <button type="submit" name="declined" class="btn btn-danger" style="width: 30%;">Decline</button>
                                                        </div>
                                                    </div>
                                                </form>
