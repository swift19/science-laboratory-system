...
<html lang="en">
    <head>
        ...
        <title>SLS Admin | Add Type </title>
                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php } ?>
                                                ...
                                                <div class="col-lg-6">
                                                <input type="text" name="type" class="form-control" id="type" required="required" autocomplete="off">
                                                </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Add Inventory Type</button>
                                                        </div>
                                                    </div>
                                                </form>
